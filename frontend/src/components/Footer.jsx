    ...
    <footer className="bg-stone-900 text-stone-400 mt-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <div className="flex items-center gap-2">
              <img src="/logo.svg" alt="NextBasket" className="w-8 h-8" />
              <span className="font-display text-2xl text-white tracking-[0.15em]">NextBasket</span>
            </div>
        ...
        <div className="border-t border-stone-800 mt-10 pt-6 text-center text-xs text-stone-600 font-mono">
          © {new Date().getFullYear()} NextBasket — Built for portfolio demonstration
        </div>
      </div>
    </footer>
  )
