      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <Link to="/" className="flex items-center gap-2 group">
            <img src="/logo.svg" alt="NextBasket" className="w-10 h-10 group-hover:opacity-80 transition-opacity" />
            <span className="font-display text-2xl font-medium tracking-[0.15em] text-stone-900 group-hover:text-amber-600 transition-colors">NextBasket</span>
          </Link>
